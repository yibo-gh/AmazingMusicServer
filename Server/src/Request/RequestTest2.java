...
public class RequestTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Request.upload(Request.login("icho4@ucsc.edu", "cofls8680*"), "C:\\Users\\�ο�\\Desktop\\DailyScrum&Plan\\Plan15.7.18.txt"));
		System.out.println(Request.upload(Request.login("icho4@ucsc.edu", "cofls8680*"), "C:\\Users\\�ο�\\Desktop\\DailyScrum&Plan\\Plan15.7.txt"));
		*/
