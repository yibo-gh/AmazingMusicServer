...
public class FunctionalityTest {
	...
	private static String[] musics = {"B Rossette 하얀거탑.mp3", "Bishop's Mess.mp3", "Final Fantasy XIII-2 B Rossette.mp3", "King's Rage.mp3", "Beethoven Violin Sonata No.5 'Spring' Mov.1.mp3"};
